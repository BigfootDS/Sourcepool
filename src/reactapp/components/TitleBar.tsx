...
const minimizeImage: string = require("../../shared/assets/buttons/minimize_FILL0_wght400_GRAD0_opsz24.svg");
const maximizeImage: string = require("../../shared/assets/buttons/check_box_outline_blank_FILL0_wght400_GRAD0_opsz24.svg");
const exitImage: string = require("../../shared/assets/buttons/close_FILL0_wght400_GRAD0_opsz24.svg");

const gameLogo: string = require("../../shared/assets/logo/apple-touch-icon.png");
...
export default function TitleBar() {
	...
	window.electronAPI.fullscreenSendUpdate((value: number) => {
