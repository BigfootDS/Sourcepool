const { networkInterfaces, hostname, userInfo } = require("node:os");
const ciao = require("@homebridge/ciao");
const { default: Bonjour, Service } = require("bonjour-service");
